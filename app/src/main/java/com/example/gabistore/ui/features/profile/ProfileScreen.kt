...
import com.example.gabistore.ui.features.product.MainTextField
...
import com.example.gabistore.util.styleTime
...
fun AddUserLocationDataDialog(
    ...
    val fraction = if (showSaveLocation) 0.355f else 0.285f
